...
## Summary
I’d build an AI “rewriting coach” for teachers: it doesn’t write for students, it diagnoses drafts (punctuation, coherence, time/place anchors) and suggests 2–3 concrete revision moves. It enables frequent practice, frees teacher time, and stays safe via clear rules and validation.
